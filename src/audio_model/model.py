...
from src.audio_model.base import HiggsAudioPreTrainedModel
from src.audio_model.config import HiggsAudioConfig, HiggsAudioEncoderConfig
from src.audio_model.enums import GenerationMode
from src.audio_model.whisper_utils import _whisper_encoder_zero_shape_forward
from src.audio_model.attention_utils import _prepare_4d_causal_attention_mask_with_cache_position
from src.audio_model.feature_projector import HiggsAudioFeatureProjector
from src.audio_model.encoder import HiggsAudioEncoder
from src.audio_model.decoder_layer import HiggsAudioDualFFNDecoderLayer
from src.audio_model.outputs import HiggsAudioModelOutputWithPast, HiggsAudioGenerationOutput
...
# All extracted components have been moved to separate files:
# - GenerationMode -> enums.py
# - _whisper_encoder_zero_shape_forward -> whisper_utils.py
# - _prepare_4d_causal_attention_mask_with_cache_position -> attention_utils.py
# - HiggsAudioFeatureProjector -> feature_projector.py
# - HiggsAudioEncoder -> encoder.py
# - HiggsAudioDualFFNDecoderLayer -> decoder_layer.py
# - HiggsAudioModelOutputWithPast, HiggsAudioGenerationOutput -> outputs.py
...
class HiggsAudioModel(HiggsAudioPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: HiggsAudioConfig):
        ...
        self.decode_graph_runners = defaultdict(dict)
